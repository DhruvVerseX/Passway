    ...
    <main className="auth-page min-h-screen bg-[#0b0d0b] text-white selection:bg-[#b9f55d]/25">
      ...
      <section className="relative z-10 mx-auto grid min-h-[calc(100vh-76px)] max-w-[1160px] items-center gap-16 px-5 pb-16 pt-6 sm:px-8 lg:grid-cols-[1fr_460px] lg:pb-24">
        ...
        <div className="auth-card reveal w-full rounded-[24px] border border-white/[0.075] bg-[#10130f]/90 p-5 shadow-[0_35px_100px_rgba(0,0,0,0.4)] backdrop-blur-xl sm:p-8">
          ...
          <div className="mb-6 grid h-12 w-12 place-items-center rounded-xl border border-[#b9f55d]/16 bg-[#b9f55d]/[0.06] text-[#b9f55d]">
            <KeyRound size={21} />
          </div>
          ...
          <form onSubmit={submit} className="space-y-4">
            {step === "request" ? (
              <label className="block">
                ...
                <span className="group relative block">
                  <span className="pointer-events-none absolute inset-y-0 left-3.5 grid place-items-center text-white/25">
                    <Mail size={15} />
                  </span>
                  <input
                    required
                ...
                <label className="block">
                  ...
                  <span className="group relative block">
                    ...
                    <button
                      ...
                      className="absolute inset-y-0 right-3 grid place-items-center px-1 text-white/30"
            ...
            {errorMessage && (
              <p role="alert" className="text-xs text-red-300">
                {errorMessage}
                {errorMessage.includes("No Passway account") && (
                  <a
                    href="/auth/signup"
                    className="ml-1 font-medium text-[#b9f55d] hover:underline"
                  >
                    Create an account
                  </a>
                )}
          ...
          {step === "reset" && (
            <button
              ...
              className="mt-3 w-full text-center text-xs text-white/40 hover:text-white/75"
            >
